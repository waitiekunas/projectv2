...
export const selectLessonsMaterial = (state: RootState) =>
  state.apiData.lessonsMaterial
export const selectAuthorInfo = (state: RootState) => state.apiData.authorInfo
export const selectAuthorLessonsList = (state: RootState) =>
  state.apiData.authorLessonsInfo
